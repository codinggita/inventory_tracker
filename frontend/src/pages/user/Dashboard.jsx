...
const DashboardSkeleton = () => (
  <MainLayout>
    <div className="space-y-16 py-8">
      <Skeleton variant="rectangular" height={400} sx={{ borderRadius: '48px' }} />
        ...
        <div className="lg:col-span-3 space-y-16">
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <Skeleton variant="rectangular" height={120} sx={{ borderRadius: '32px' }} />
            </Grid>
            <Grid item xs={12} md={6}>
              <Skeleton variant="rectangular" height={120} sx={{ borderRadius: '32px' }} />
            </Grid>
...
const Dashboard = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard | Shelf Scout</title>
        <meta name="description" content="View your Shelf Scout dashboard, trending products, and nearby stores." />
      </Helmet>
